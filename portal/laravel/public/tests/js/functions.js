    ...
    $(".show_users").bind("click", function(e){
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                var usuarios = "";        
                for(datos in data.usuario){
                    usuarios += "<div class='panel callout radius'>";
                    usuarios += "<p>Nombre: " + data.usuario[datos].nombre + "</p>";
                    usuarios += "<p>Email: " + data.usuario[datos].correo + "</p>";
                    usuarios += "<p>Password: " + data.usuario[datos].id_usuario + "</p>";
                    usuarios += "</div>";
                }
                $(".load_ajax").html(usuarios);     
            }
